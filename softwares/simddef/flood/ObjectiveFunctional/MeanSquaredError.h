...
class MeanSquaredError : public ObjectiveFunctional
{
...
public:
   ...
   explicit MeanSquaredError(MultilayerPerceptron*);

   // INPUT-TARGET DATA SET CONSTRUCTOR

   explicit MeanSquaredError(InputTargetDataSet*);

   // GENERAL CONSTRUCTOR

   explicit MeanSquaredError(MultilayerPerceptron*, InputTargetDataSet*);
