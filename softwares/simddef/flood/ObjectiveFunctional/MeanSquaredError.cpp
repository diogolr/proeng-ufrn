...
/// Multilayer perceptron constructor. It creates a mean squared error objective functional object associated to a 
...
MeanSquaredError::MeanSquaredError(MultilayerPerceptron* new_multilayer_perceptron_pointer)
...
/// Multilayer perceptron constructor. It creates a mean squared error objective functional object not associated to any 
...
MeanSquaredError::MeanSquaredError(InputTargetDataSet* new_input_target_data_set_pointer)
: ObjectiveFunctional()
{
...
void MeanSquaredError::set(void)
{
...
void MeanSquaredError::set(MultilayerPerceptron* new_multilayer_perceptron_pointer)
{
...
void MeanSquaredError::set(InputTargetDataSet* new_input_target_data_set_pointer)
{
   multilayer_perceptron_pointer = NULL;
   input_target_data_set_pointer = new_input_target_data_set_pointer;
   set_default();
...
void MeanSquaredError::set(MultilayerPerceptron* new_multilayer_perceptron_pointer, InputTargetDataSet* new_input_target_data_set_pointer)
{
   multilayer_perceptron_pointer = new_multilayer_perceptron_pointer;
   input_target_data_set_pointer = new_input_target_data_set_pointer;
   set_default();
...
void MeanSquaredError::set_input_target_data_set_pointer(InputTargetDataSet* new_input_target_data_set_pointer)
{
   input_target_data_set_pointer = new_input_target_data_set_pointer;
}
...
double MeanSquaredError::calculate_objective(void)
{
   ...
   {
      std::cerr << "Flood Error: MeanSquaredError class." << std::endl
   ...
   return(training_error/(double)training_instances_number);
}


// double calculate_validation_error(void) method

/// This method returns the mean squared error of the multilayer perceptron measured on the validation instances of the 
/// input-target data set.

double MeanSquaredError::calculate_validation_error(void)
{
   // Control sentence (if debug)
   ...
   {
      std::cout << "Flood Error: MeanSquaredError class." << std::endl
                << "double calculate_validation_error(void) method." << std::endl
   ...
   else
   {
      ...
      return(validation_error/(double)validation_instances_number);
   }
}
...
Vector<double> MeanSquaredError::calculate_objective_gradient(void)
{
   // Control sentence (if debug)
...
Vector<double> MeanSquaredError::calculate_output_errors
(const Vector< Vector<double> >& forward_propagation_derivative, const Vector<double>& target)
{
   ...
   switch(outputs_unscaling_method)
   {
      ...
      {   
         ...
         output_errors = output_layer_output_derivative*2.0*error/(double)training_instances_number;
	  } 
      break;
      ...
      case MultilayerPerceptron::MinimumMaximum:
      {
		 ...
		 int output_variables_minimum_size = multilayer_perceptron_pointer->get_output_variables_minimum().get_size();
		 int output_variables_maximum_size = multilayer_perceptron_pointer->get_output_variables_maximum().get_size();
         ...
         Vector<double> output_variables_range = output_variables_maximum-output_variables_minimum;
   	     ...
   	     output_errors = output_layer_output_derivative*(output_layer_output-target)*output_variables_range/(double)training_instances_number;
      }		 
      break;
...
Vector< Vector<double> > MeanSquaredError::calculate_hidden_errors
...
Vector<double> MeanSquaredError::calculate_hidden_layers_error_gradient
 ...
 const Vector< Vector<double> >& hidden_errors)
{
   ...
   if(input_size != inputs_number)
   {
      std::cerr << "Flood Error: SumSquaredError class." << std::endl
                ...
                << "Size of input (" << input_size << ") must be equal to inputs number (" << inputs_number << ")." << std::endl;
...
Vector<double> MeanSquaredError::calculate_output_layer_error_gradient
(const Vector< Vector<double> >& forward_propagation_derivative, const Vector<double>& output_errors)
{
   int outputs_number = multilayer_perceptron_pointer->get_outputs_number();
   int hidden_layers_number = multilayer_perceptron_pointer->get_hidden_layers_number();
...
Matrix<double> MeanSquaredError::calculate_Jacobian(void)
{
   // Control sentence (if debug)
